...
public class FieldOfVision : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Vector3 fovLine1 = Quaternion.AngleAxis(-viewAngle * 0.5f, transform.up) * transform.forward * viewRadius;
        Vector3 fovLine2 = Quaternion.AngleAxis(viewAngle * 0.5f, transform.up) * transform.forward * viewRadius;
